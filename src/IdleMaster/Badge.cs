...
namespace IdleMaster
{
    public class Badge
    {
        ...
        public Process Idle()
        {
            ...
            _idleProcess =
                Start(
                    new ProcessStartInfo("steam-idle.exe", AppId.ToString()) {WindowStyle = ProcessWindowStyle.Hidden});
            return _idleProcess;
        }
        ...
        public async Task<bool> CanCardDrops()
        {
            try
            {
                ...
                var response =
                    await CookieClient.GetHttpAsync($"{Settings.Default.myProfileURL}/gamecards/{StringId}");
        ...
        {
            return @object is Badge badge && Equals(AppId, badge.AppId);
        }
